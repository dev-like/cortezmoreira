    ...
    <div class="modal-content">
      ...
      <div class="row">
        <div class="form-group col-md-12">
          <img src="{{ asset('uploads/premio/'.$premios->imagem) }}" style="width: 50%">
        </div>
      </div>
    </div>
  </div>
...
<div class="col-12">
  <div class="card-box">
    {{ Form::model($premios, ['route' => ['premios.update', $premios->id], 'method' => 'PUT', 'files' => true]) }}
      <div class="row">
        <div class="form-group col-md-7">
          {{ Form::label('imagem','Imagem') }}
          <input type="file" name="imagem" id="profile-img" class="filestyle" data-buttonText="Carregar" data-placeholder="{{$premios->imagem}}" data-btnClass="btn-light">
        </div>
      ...
      <div class="row" style="margin-top: 20px">
        <div class="form-group col-12">
          <div class="text-center">
            ...
            <a href="{{ route('premios.index') }}" class="btn btn-danger"><i class="fa fa-window-close m-r-5"></i> Cancelar</a>
          </div>
        </div>
      </div>
    {{ Form::close() }}
